...
def concatenate(tensors: Collection[Tensor], axis: int = 0) -> Tensor:
    ...
    return Tensor(_concatenate([tensor.nd for tensor in tensors], axis), [tensor for tensor in tensors], is_leaf=False, grad_fn=grad_fn)